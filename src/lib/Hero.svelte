...
<header>
	<div
		class="bg-gradient-to-r from-brand to-cyan-600 text-stone-100 mx-auto rounded-xl p-8 grid grid-cols-3 relative mt-28 shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]"
	>
